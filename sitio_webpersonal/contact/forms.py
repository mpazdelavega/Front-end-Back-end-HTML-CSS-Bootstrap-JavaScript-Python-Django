...
class ContactForm(forms.Form):
    ...
    content = forms.CharField(label="Contenido", required=True, widget=forms.Textarea(attrs={'class':'form-control','placeholder':'Escribenos tu mensaje','rows':3}), min_length=10, max_length=300)